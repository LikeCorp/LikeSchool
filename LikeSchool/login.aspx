            ...
            <div id="span5 offset5">
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input-xlarge usernameClass" id="user" runat="server" onkeydown="javascript:fnHideMessage()"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" class="input-xlarge passwordClass" id="pass" runat="server" onkeydown="javascript:fnHideMessage()"
