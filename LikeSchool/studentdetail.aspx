    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span3">
                ...
                <div class="prof">
                        <h3>Overall Profile Progress</h3>
                        <h1 id="precentage"><%=Percentage%>%</h1>
                ...
                <div id="profile" class="profs" style="display: none;">
                    ...
                    <div class="tabbable tabs-right">
                        <ul id="myTab" class="nav nav-tabs">
                            ...
                            <li class=""><a href="#communicationTab" data-toggle="tab">Contact</a></li>
                            <li class=""><a href="#otherTab" data-toggle="tab">Personal</a></li>
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade" id="otherTab">
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btn btn-info">
                                        <i class="icon-plus icon-black"></i>&nbsp;Add Personal details
                                    </button>
                                </div>
                                <%} %>
                                <%}
                            ...
                            <div class="tab-pane fade" id="parentTab">
                                <legend>Parend/Guardian Details</legend>
